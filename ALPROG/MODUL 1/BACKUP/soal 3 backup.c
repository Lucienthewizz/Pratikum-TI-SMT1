...
float volumeLimasSegiEmpat(float luasAlas, float t);
...
int validasi2angka_Pilihan(int min, int maks){
  ...
  do{
    ...
    if(sscanf(buffer, "%d%c", &valid, &invalid) ==1 && valid >= min && valid <= maks){
      ...
      printf("Inputan tidak ada dalam list, tolong input ulang!\n");
      printf("\nPilihan mu: ");
    }
  } while(1);
}

int validasi1angka_Isi(int range){
...
int validasi1angka_Loop(int range){
...
int main() {
    ...
    float r/*Jari-Jari*/, t/*tinggi*/, luasAlas, sisiMiring, sisiTegak;
    ...
    switch (bangunRuang) {
        case 1: //Tabung
            ...
            r = validasi1angka_Isi(0);
            // scanf("%f", &r);
            printf("Masukkan tinggi tabung: ");
            t = validasi1angka_Isi(0);
            // scanf("%f", &t);
        ...
        case 4: //Prisma Segitiga
            ...
            sisiTegak = validasi1angka_Isi(0);
            // scanf("%f", &sisiTegak);
        ...
        default: //Validasi Terjadi jika tidak memilih dari bangun Ruang yang ada dalam list
            printf("Inputan tidak ada dalam list! \n");
            break;
        }
    
    //Inputan agar program bisa berhenti
    printf("\nApakah Ingin Lanjut (1 untuk iya, 0 untuk tidak): ");
    pilihan = validasi1angka_Loop(0);
    // scanf("%d", &pilihan);
    printf("\n");
    }
    while(pilihan == 1);
